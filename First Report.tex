...
a web-application designed to work on mobile devices

\subsection{programming language}
Javascript for the frontend, and C\# for the backend.
...
\begin{table}[H]
    \centering
    \begin{tabular}{l|l|l|}
        \textbf{Task} & \textbf{Time estimated} & \textbf{Time spent per team member}  \\
        \hline
        set up git environment & NA & fill this in later \\
        write first report & NA & fill in later\\
        set up issue tracker & NA & fill in later \\
        create initial backlog & NA & all members spent 15 min \\
